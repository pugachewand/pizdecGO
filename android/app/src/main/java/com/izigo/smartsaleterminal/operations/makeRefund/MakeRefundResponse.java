...
public class MakeRefundResponse extends PosActivityResponseBase {
    ...
    protected MakeRefundResponse(PosTerminalOperation operation, String terminalId,
    ...
    private static MakeRefundResponse createFailed(
            PosTerminalOperation operation, String terminalId, PosActivityResultCode resultCode, String errorMessage) {

        MakeRefundResponse response = new MakeRefundResponse(operation, terminalId, resultCode, errorMessage);
    ...
    @NonNull
    public static MakeRefundResponse create(
        ...
        MakeRefundResponse response = new MakeRefundResponse(operation, terminalId,
